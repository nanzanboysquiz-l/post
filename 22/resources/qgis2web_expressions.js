...
function exp_P3013_22_1rule0_eval_expression(context) {
    // 
...
function exp_P3013_22_1rule1_eval_expression(context) {
    // "風景印_22(静岡県)_自治体" IS NOT NULL AND "風景印_22(静岡県)_取得" IS NOT NULL

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('風景印_22(静岡県)_自治体')  !== null) && (feature.get('風景印_22(静岡県)_取得')  !== null));
    } else {
        return ((feature.get('風景印_22(静岡県)_自治体')  !== null) && (feature.get('風景印_22(静岡県)_取得')  !== null));
    }
}
...
function exp_P3013_22_1rule2_eval_expression(context) {
    // "風景印_22(静岡県)_取得" IS NOT 1 AND "風景印_22(静岡県)_自治体" IS NOT NULL

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('風景印_22(静岡県)_取得')  !== 1) && (feature.get('風景印_22(静岡県)_自治体')  !== null));
    } else {
        return ((feature.get('風景印_22(静岡県)_取得')  !== 1) && (feature.get('風景印_22(静岡県)_自治体')  !== null));
    }
}